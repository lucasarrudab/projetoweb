...
{
    /// <inheritdoc />
    public partial class mysqlnuvem1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Produtos",
                columns: new[] { "Id", "Codigo", "DataCadastro", "Estoque", "Nome", "Preco" },
                values: new object[,]
                {
                    { 1, "1234567", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 10000, "Pão Carioca", 1.0m },
                    { 2, "7654321", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 10000, "Salgado", 5.0m }
                });
